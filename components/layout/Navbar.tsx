          ...
          <div className="flex items-center space-x-2">
            ...
            {status === 'loading' ? (
              ...
              <div className="relative">
                ...
                >
                  <div className="h-6 w-6 bg-blue-600 dark:bg-blue-500 flex items-center justify-center text-white text-xs font-medium">
                ...
                {showMenu && (
                  <div className="absolute right-0 mt-2 w-56 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 z-50">
              ...
              <button
                ...
                className="px-4 py-2 text-sm font-medium text-white bg-blue-600 hover:bg-blue-700 dark:bg-blue-500 dark:hover:bg-blue-600 transition-colors"
              >
                Zaloguj się
              </button>
            )}
