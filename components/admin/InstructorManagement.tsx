...
export function InstructorManagement() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!formData.full_name || abbreviationsArray.length === 0) {
      toast.error('Podaj imię i nazwisko oraz przynajmniej jeden alias');
      return;
    }
    ...
    if (!editingId) {
      ...
      if (duplicateAbbr) {
        toast.error(`Alias "${duplicateAbbr}" jest już używany przez innego wykładowcę`);
        return;
      }
                  ...
                  <table className="w-full text-sm">
                    <thead className="bg-gray-50 sticky top-0">
                      <tr>
                        ...
                        <th className="px-3 py-2 text-left text-xs font-medium text-gray-700">Alias</th>
                          ...
                          <td className="px-3 py-2">
                            {item.isDuplicate ? (
                              <span className="text-xs text-red-600 font-medium">
                                Duplikat {item.duplicateType === 'abbr' ? 'aliasu' : 'nazwiska'}
                              </span>
                            ) : (
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <p className="text-xs text-gray-500 mt-1">
              Może być wiele aliansów, np: JK | J.Kowalski | dr J.K.
            </p>
          </div>
        ...
        <div className="p-4 border-b border-gray-200 space-y-4">
          ...
          <div>
            <input
              ...
              placeholder="Szukaj po nazwisku lub aliasie..."
